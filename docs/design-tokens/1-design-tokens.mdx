...
Design tokens are the foundations of a strong Design System — they are __the visual atoms
of the Design System__. Tokens are a set of <strong>visual properties</strong> such as
