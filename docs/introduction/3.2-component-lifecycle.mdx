...
<Intro>
  ...
  Maintaining Status would maybe require something like: https://www.supernova.io/design-system-management
</Intro>

## Managing Component Status

Component status can be set via Storybook's story  `tags` parameter (more of [Storybook tags](https://storybook.js.org/docs/writing-stories/tags)). For example, for `Input.stories.tsx`:
