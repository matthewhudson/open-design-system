...
*Create Figma prototypes a using atomic design principles and design tokens. Cross-functional review to ensure alignment and readiness.*  
...
*Release to production, gather feedback and iterate.*  
