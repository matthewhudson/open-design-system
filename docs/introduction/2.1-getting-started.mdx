...
- **Homogenised experience**: following a shared design language, the different products forming our product experiences will share the same behaviours and patterns.
...
- **Consistency**: Unified interaction patterns and visual language across all products
...
- **Adaptability**: Flexible theming system for brand-specific implementations
- **Collaboration**: Shared vocabulary between designers and developers

As a design language, it is only relevant if it is a foundation, a baseline behind every facet of our products (ideation, design, implementation).
...
Questions? Concerns? Don't see what you need, check out our [Governance](#todo) documentation.
